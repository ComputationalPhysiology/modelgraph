...
A tool for visualizing dependencies between different components of your
model.

Motivation
----------

Assume you have some model, represented as a system of ODEs with
potentially several intermediation expression. For example in the
classical Hodgkin Huxley model of the squid axon from 1952 we have the
...
.. figure:: _static/dV_dt_pydot.png
...
http://computationalphysiology.github.io/modelgraph.

Automated test
--------------

Tests are provided in the folder
`tests <https://github.com/ComputationalPhysiology/modelgraph/tree/main/tests>`__.
...
section <https://computationalphysiology.github.io/simcardems/CONTRIBUTING.html>`__
...
.. |github pages| image:: https://github.com/ComputationalPhysiology/modelgraph/actions/workflows/github-pages.yml/badge.svg
   :target: https://github.com/ComputationalPhysiology/modelgraph/actions/workflows/github-pages.yml
.. |pre-commit.ci status| image:: https://results.pre-commit.ci/badge/github/ComputationalPhysiology/modelgraph/main.svg
   :target: https://results.pre-commit.ci/latest/github/ComputationalPhysiology/modelgraph/main
